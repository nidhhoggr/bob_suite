...
CREATE TABLE bird (id BIGINT AUTO_INCREMENT, name VARCHAR(72), propername VARCHAR(72), imageurl TEXT, wikipedia text, about text, paraphrased TINYINT(1) DEFAULT '0' NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE taxonomy (id BIGINT AUTO_INCREMENT, taxonomytype_id BIGINT NOT NULL, name VARCHAR(72), INDEX taxonomytype_id_idx (taxonomytype_id), PRIMARY KEY(id)) ENGINE = INNODB;
